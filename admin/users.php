...
$query3 = "SELECT * FROM users WHERE user_type = 3 ";
...
<title>Scale | Web Application</title>
 ...
 </script> <script src="js/ie/excanvas.js"></script> <![endif]-->
                          ...
                          <li><a href="verifyusers.php" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Verify Users</span> </a> 
                            ...
                            <section class="row m-b-md">
                                ...
                                <section class="panel panel-default"> 
                                  <header class="panel-heading font-bold">Users</header> 
                             <div class="table-responsive"> 
                                  <table class="table table-responsive">
                                   ...
                                   <?php while($data = $result3->fetch_assoc()){?>
                                      <tr>
                                        <td>
                                        <?php echo $data['firstname']." ".$data['lastname']?></td>
